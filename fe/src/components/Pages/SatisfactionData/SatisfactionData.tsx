...
import SuccsessPage from "../SuccessPage/SuccsessPage";
...
const SatisfactionData = () => {
    ...
    const [isSumitted, setIsSumitted] = React.useState(false);
    ...
    return (
        <>
            {isSumitted ? (
                <SuccsessPage error={isError} msg={!isError ? "Data recoded successfully" : "Data failed to record"}/>
            ) : (
                <Container>
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={6}>
                            ...
                            <TextField
                                ...
                                className={TextFieldStyles}
                                value={employeeCount}
                                onChange={(event: any) => { setEmployeeCount(validateNumberInput(event.target.value)) }}
                            />
                            <TextField
